...
namespace Testing
{
    public class RBTree
    {
        ...
        private class Node
        {
            ...
            public Node(int i, Node p, Colour col)
            {
                val = i;
                colour = col;
                left = null;
        ...
        private void Delete(Node r, int value)
        {
            if (r == null)
            {
                return;
        ...
        private int InorderSuccessorVal(Node r)
        {
            if (r.Left == null) return r.Val;
            else return InorderSuccessorVal(r.Left);
        }

        private void Insert(Node pn, int value)
        {
            if (pn.Val > value)
            {
                if (pn.Left == null)
